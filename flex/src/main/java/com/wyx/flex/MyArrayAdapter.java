...
/**
 * 自定义的{@link android.widget.ArrayAdapter}，添加工具方法：
 * <p/>
 * {@link #set(Collection)} - 设置数据集合；
 * <p/>
 * {@link #getList()}
 * <p/>
 */
@SuppressWarnings("unused") public class MyArrayAdapter<T> extends BaseAdapter implements Filterable {
  /**
   ...
   */
  public static MyArrayAdapter<CharSequence> createFromResource(Context context, int textArrayResId,
      int textViewResId) {
    ...
    @Override protected FilterResults performFiltering(CharSequence prefix) {
      ...
      if (prefix == null || prefix.length() == 0) {
        ...
        for (final T value : values) {
          ...
          // First match against the whole, non-spitted value
